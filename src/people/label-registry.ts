...
const RAW_LABELS: RawPeopleLabel[] = [
  ...
  { label: "personEducationalActivities", payloadTypes: ["stringCollection"], graphType: "educationalActivity" },
  { label: "personInterests", payloadTypes: ["stringCollection"], graphType: "personInterest" },
  { label: "personLanguages", payloadTypes: ["stringCollection"], graphType: "languageProficiency" },
  { label: "personPatents", payloadTypes: ["stringCollection"], graphType: "itemPatent" },
  { label: "personProjects", payloadTypes: ["stringCollection"], graphType: "projectParticipation" },
  { label: "personPublications", payloadTypes: ["stringCollection"], graphType: "itemPublication" },
