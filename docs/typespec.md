...
- Generated TypeScript people helpers reject invalid JSON or non-object payloads at runtime.
- Generated .NET people helpers rely on schema validation and typed construction for payload shape, and still enforce collection limits for labels such as addresses and emails.
