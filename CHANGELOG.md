...
- `cocogen init --kind people` now includes `personWorkPositions` guidance in the starter schema and generated `AGENTS.md`, along with the people ACL preview rule.
